    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      <ul className="navbar-nav me-auto mb-2 mb-lg-0">
        <li className="nav-item">
          <Link className="nav-link tcolor"  aria-current="page" to="Textutils-React" onClick={props.pageChange} >Home</Link>
        </li>
        <li className="nav-item">
          <Link className="nav-link" to="Textutils-React/about" onClick={props.pageChange} >About</Link>
        </li>
      </ul>
